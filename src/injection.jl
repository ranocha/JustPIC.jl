...
@parallel_indices (icell, jcell) function check_injection!(inject::BitArray{T,3}, index, min_xcell) where T
...
@parallel_indices (icell, jcell, kcell) function check_injection!(inject::BitArray{T,4}, index, min_xcell) where T
